...
function CreateGround(scene) {
	var ground = BABYLON.Mesh.CreateGroundFromHeightMap("ground", "images/hmap2.jpg", 400, 400, 250, 0, 10, scene, false, OnGroundCreated);
    console.log(ground);
...
function createTank(scene) {
    var tank = new BABYLON.MeshBuilder.CreateBox("heroTank", { height: 3, depth: 5, width: 3 }, scene);
...
function DoClone(original, skeletons, id) {
    var myClone;
    var xrand = Math.floor(Math.random() * 1001) - 250;
    var zrand = Math.floor(Math.random() * 1001) - 250;
